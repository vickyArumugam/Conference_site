...
const ContactForm = () => {
  ...
  return (
    <div className="bg-cover bg-center bg-[#E8E8E8] flex flex-col min-h-screen">
      <div className="container mx-auto  flex flex-col md:flex-row justify-between items-center flex-1 px-4 gap-5"> {/* gap-5 added here */}
        
        {/* Form Section */}
        <div className="flex flex-col md:flex-row bg-white rounded-lg overflow-hidden shadow-lg max-w-4xl w-full p-8 space-y-4 md:space-y-0">
          ...
          {/* Form Section */}
          <form className="w-full md:w-1/2 p-4 flex flex-col justify-center space-y-4">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md md:w-1/2 flex flex-col items-center space-y-2 mb-10 mt-10">
