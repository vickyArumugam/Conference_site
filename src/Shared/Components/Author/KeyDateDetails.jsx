  ...
  const keyDates = [
    {
      ...
      description: "The call for papers will open on this date. Researchers can start submitting their abstracts and papers.",
      color: "blue",
    },
    {
      event: "Paper Submission Deadline",
      date: "March 31, 2025",
      description: "This is the last date to submit your research papers. Make sure to review the submission guidelines.",
      color: "green",
    },
    {
      event: "Notification of Acceptance",
      date: "May 15, 2025",
      description: "Authors will be notified about the acceptance or rejection of their submissions on this date.",
      color: "purple",
    },
    {
      event: "Early Bird Registration Ends",
      date: "June 30, 2025",
      description: "Register before this date to avail of early bird discounts for conference participation.",
      color: "orange",
    },
    {
      event: "Conference Dates",
      date: "August 20-22, 2025",
      description: "The main conference will take place over three days. Attendees can participate in keynote sessions, workshops, and networking events.",
      color: "red",
    },
    {
      event: "Final Paper Submission",
      date: "July 15, 2025",
      description: "Final versions of accepted papers must be submitted by this date for inclusion in the conference proceedings.",
      color: "teal",
    },
  ];

  // Function to get dot color
