...
const Organizing_Committee = () => {
  return (
    ...
    <div
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.5)), url('public/images/business-1.jpg')`,
      }}
    >
      <div className="text-center max-w-3xl">
        <h1 className="text-4xl font-bold mb-4">OrganizingCommittee</h1>
      </div>
